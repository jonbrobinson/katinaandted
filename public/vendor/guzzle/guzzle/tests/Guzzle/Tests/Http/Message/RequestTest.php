...
class RequestTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testRequestHasPath()
    {
        ...
        $this->assertEquals($this->request, $this->request->setPath('/index_original.html'));
        $this->assertEquals('/index_original.html', $this->request->getPath());
        $this->assertEquals($this->request, $this->request->setPath('index_original.html'));
        $this->assertEquals('/index_original.html', $this->request->getPath());
    }
    ...
    public function testGetResourceUri()
    {
        ...
        $this->request->setPath('/index_original.html');
        $this->assertEquals('/index_original.html', $this->request->getResource());
        $this->request->getQuery()->add('v', '1');
        $this->assertEquals('/index_original.html?v=1', $this->request->getResource());
    }
    ...
    public function testRequestCanBeSentUsingCurl()
    {
        ...
        try {
            $request = RequestFactory::getInstance()->create('GET', $this->getServer()->getUrl() . 'index_original.html');
            $request->setClient($this->client);
            $response = $request->send();
        ...
        $this->assertEquals('/index_original.html', $requests[2]->getPath());
        ...
        $parts = explode("\r\n", $messages[2]);
        $this->assertEquals('GET /index_original.html HTTP/1.1', $parts[0]);
    }
    ...
    public function testThrowsExceptionsWhenUnsuccessfulResponseIsReceivedByDefault()
    {
        ...
        try {
            $request = $this->client->get('/index_original.html');
            $response = $request->send();
            $this->fail('Request did not receive a 404 response');
        } catch (BadResponseException $e) {
            $this->assertContains('Client error response', $e->getMessage());
